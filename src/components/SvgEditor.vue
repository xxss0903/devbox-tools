      ...
      <div class="editor-content">
        <div class="input-section">
          ...
          <label for="image-input" class="file-input-label">
            <input id="image-input" type="file" @change="embedImage" accept="image/png,image/jpeg" class="file-input" />
            <span>嵌入图片到 SVG</span>
          </label>
        ...
        <div class="preview-section">
          <div class="svg-code">
            <textarea v-model="svgContent" @input="updatePreview" placeholder="在此编辑 SVG 代码"></textarea>
          </div>
...
.editor-content {
  ...
  .file-input-label, .action-button, .zoom-button {
  ...
  .file-input-label:hover, .action-button:hover, .zoom-button:hover {
  ...
  .svg-code, .svg-preview-container {
    flex: 1;
